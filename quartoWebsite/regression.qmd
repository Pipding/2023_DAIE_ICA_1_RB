...
By plotting both budget and dev count, we can visualize which of these factors contributes more heavily to the likelihood of missing a milestone.
...
multilinearModel <- lm(MissedMilestone ~ Budget + AssetDevCount, data = startedProjects)


ggplt <- ggplot(startedProjects,aes(x=Budget,y=AssetDevCount,shape=MissedMilestone))+ 
         geom_point()
