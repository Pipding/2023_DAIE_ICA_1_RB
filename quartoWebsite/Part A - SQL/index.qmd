...
# Show up to 7 rows. If data has more than 7 entries, show the first 8 with pagination
if(length(avgDevTimeByAssetCount) <= 7) {
...
# Show up to 7 rows. If data has more than 7 entries, show the first 8 with pagination
if(length(mostSuccessfulDevs) <= 7) {
...
# Show up to 7 rows. If data has more than 7 entries, show the first 8 with pagination
if(length(designersAndEngineersExperience) <= 7) {
...
# Show up to 7 rows. If data has more than 7 entries, show the first 8 with pagination
if(length(projectLeads) <= 7) {
  knitr::kable(head(projectLeads, 7))
} else {
...
# Show up to 7 rows. If data has more than 7 entries, show the first 8 with pagination
if(length(multiProjectDevs) <= 7) {
  knitr::kable(head(multiProjectDevs, 7))
} else {
